...
def log_to_frontend(level: str, message: str, user: Optional[Dict[str, Any]] = None, meta: Optional[Dict[str, Any]] = None, error: Optional[Exception] = None):
    """
    Log messages to the frontend with enhanced error handling.
    ...
    try:
        ...
        print(f"Failed to log to frontend: {str(e)}")
