...
console.log('Final path to use:', process.env.PUPPETEER_EXECUTABLE_PATH || '/usr/bin/chromium-browser');
...
async function testConfig() {
  try {
    ...
    console.log('✅ Using executable path:', process.env.PUPPETEER_EXECUTABLE_PATH || '/usr/bin/chromium-browser');
